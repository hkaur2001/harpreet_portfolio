...
for (const marker of ["BAD_VALUE", "BAD_CITATION", "UNAUTHORIZED_TOOL", "MISSING_POLICY", "OUTAGE"]) await post({ ...valid, question: `DESK_TEST_${marker} inspect the synthetic financial evidence.` }, 502);
