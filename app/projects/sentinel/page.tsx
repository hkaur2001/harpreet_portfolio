    ...
    <main>
      <section className="grid-field border-b border-[var(--line)]">
        <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
          ...
          <div className="mt-8 flex flex-wrap gap-3"><a href="#demo" className="btn-primary rounded-full px-5">Try an incident ↓</a><Link href="https://github.com/hkaur2001/harpreet_portfolio/tree/main/sentinel" target="_blank" rel="noreferrer" className="btn-secondary">Inspect source ↗</Link></div>
        </div>
      </section>
