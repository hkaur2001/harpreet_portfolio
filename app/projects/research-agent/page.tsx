        ...
        <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
          ...
          <ProjectHowItWorks
            steps={[
              ...
              { title: "Search the live web", body: "GPT-5.5 uses OpenAI's web-search tool and returns traceable source URLs when the provider is available. An unavailable search completes with an explicit source gap." },
            ...
            toolGroups={[
              { label: "Live in this project", items: ["GPT-5.5", "OpenAI web search", "Source citations", "Goal-aware prompting", "LLM-as-judge"] },
