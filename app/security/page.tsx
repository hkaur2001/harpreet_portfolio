...
const projectControls = [
  ["Atlas", "Public synthetic evidence; briefs in page memory; accepted process rules in this browser; no external writes", "Live model-selected tools; allowlists, budgets, actual-source citations, numeric/unit validation, and human review", "No customer systems or production SSO; model provider processes questions, reviewer feedback, and accepted rules; rules cannot grant permissions"],
      ...
      <section>
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <article className="rounded-3xl border border-[var(--line)] bg-[var(--surface)] p-7"><h3 className="text-2xl font-semibold">Data retention</h3><p className="mt-4 text-sm leading-7 text-[var(--muted)]">Atlas drafts, questions, and reviewer feedback stay in request/page memory; explicitly accepted process rules persist in this browser and can be removed. Questions, feedback, and rules are sent to the configured model provider. FieldGuide, Sentinel, Secure Knowledge, Voiceprint, SignalBrief, and Policy Radar do not intentionally persist user-entered demo content. Enough can persist plan and RSVP state when its database is configured; its product page and API health response identify the active mode.</p></article>
